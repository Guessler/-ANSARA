                    ...
                    {menuItems.map((item, index) =>
                        item.submenu ? (
                            ...
                            >
                                ...
                                {/* Подменю с анимацией и исправлениями */}
                                <div className="absolute left-1/2 -translate-x-1/2 top-full mt-2 w-48 bg-white border border-gray-200 rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 pointer-events-none group-hover:pointer-events-auto">
                                    {item.submenu.map((sub) => (
                                        <a
                                            key={sub}
                                            href="#"
                                            className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 font-sans transition-colors"
                                        >
                                            {sub}
                                        </a>
                                    ))}
